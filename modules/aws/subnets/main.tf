...
#
#  subnet_id  = aws_subnet.sub[each.value.name].id
#  #gateway_id = data.aws_internet_gateway.igw[each.value.net].id
#}
#
#resource "aws_route" "default" {
#  for_each = { for net in var.subnets : net.name => net }
#
#  route_table_id         = data.aws_route_table.route[each.value.net].main_id
...
#
#  subnet_id      = aws_subnet.sub[each.value.name].id
#  route_table_id = data.aws_route_table.route[each.value.net].id
